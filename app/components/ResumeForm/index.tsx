...
export const ResumeForm = () => {
  ...
  return (
    <div
      className={cx(
        "flex justify-center scrollbar scrollbar-track-white scrollbar-w-3 md:h-[calc(100vh-var(--top-nav-bar-height))] md:justify-end md:overflow-y-scroll",
        isHover && "scrollbar-thumb-neutral-400"
      )}
