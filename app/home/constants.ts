import { deepClone } from "../lib/parse-resume/deep-clone";
import {
  initialEducation,
  initialProfile,
  initialProject,
...
export const END_HOME_RESUME: Resume = {
  profile: {
    name: "Harsh Raj ",
    summary:
      "Software engineer obsessed with building products that people love",
    email: "harshraj211430@gmail.com",
    phone: "123-456-7890",
    location: "Patna,IND",
    url: "linkedin.com/in/entryourusername",
  },
  workExperiences: [
    {
      company: "ABC Company",
